...
eyesDetector::eyesDetector()
{
    ...
    nested_cascade = (CvHaarClassifierCascade*)cvLoad(HAAR_CASCADE_EYE.c_str (), 0, 0, 0 );
    nested_cascade_2    = (CvHaarClassifierCascade*)cvLoad(HAAR_CASCADE_EYE_2.c_str (), 0, 0, 0 );
