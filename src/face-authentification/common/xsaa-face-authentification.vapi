/* xsaa-face-authentification.vapi generated by valac-0.12 0.12.1, do not modify. */
...
namespace XSAA {
	...
	namespace FaceAuthentification {
		...
		public class EyesDetector : GLib.Object {
			public EyesDetector ();
			public void run (OpenCV.IPL.Image? inInput, OpenCV.IPL.Image inFullImage, OpenCV.Point inLT);
		...
		[CCode (ref_function = "xsaa_face_authentification_face_set_ref", unref_function = "xsaa_face_authentification_face_set_unref", cheader_filename = "xsaa-face-authentification.h")]
		...
		[CCode (cheader_filename = "xsaa-face-authentification.h")]
		public static double lbp_custom_diff (OpenCV.Matrix inModel, OpenCV.Matrix inTest, OpenCV.Matrix inWeight);
		[CCode (cheader_filename = "xsaa-face-authentification.h")]
